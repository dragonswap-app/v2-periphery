...
/// @notice Provides validation for callbacks from Dragonswap V2 Pools
library CallbackValidation {
    /// @notice Returns the address of a valid Dragonswap V2 Pool
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) internal view returns (IDragonswapV2Pool pool) {
